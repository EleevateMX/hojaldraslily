...
const CASCO = ["/hojaldraslily/app/kiosko/","/hojaldraslily/app/kiosko/assets/index-BTSZzs07.css","/hojaldraslily/app/kiosko/assets/index-DN2VN_O2.js"]
const CACHE = 'lily-casco-' + "17vz8by"
    ...
    e.respondWith(
      (async () => {
        try {
          ...
          return (await c.match("/hojaldraslily/app/kiosko/")) ?? Response.error()
        }
      })(),
    )
    return
